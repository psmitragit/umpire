                    ...
                    @if (!$upcomming_games->isEmpty())
                        @foreach ($upcomming_games as $upcoming_game)
                            @php
                                ...
                                $isAssigned = false;
                                if ($upcoming_game->ump1 == $umpire_data->umpid || $upcoming_game->ump2 == $umpire_data->umpid || $upcoming_game->ump3 == $umpire_data->umpid || $upcoming_game->ump4 == $umpire_data->umpid) {
                                    $isAssigned = true;
                                }
                                    ...
                                    @php
                                        ...
                                        for ($i = 1; $i <= $umpreq; $i++) {
                                            ...
                                            if ($upcoming_game->{$col} == null) {
                                                $pay = 0;
                                                if ($col == 'ump1') {
                                                    $pay = '$' . $upcoming_game->ump1pay . '+$' . $upcoming_game->ump1bonus;
                                                } else {
                                                    $pay = '$' . $upcoming_game->ump234pay . '+$' . $upcoming_game->ump234bonus;
                                                }
                                                if ($col == 'ump1') {
                                                    $newcol = 'Main Umpire';
                                                } elseif ($col == 'ump2') {
