        ...
        <div class="sec-2-inner">
            ...
            <div class="container new-container">
                ...
                <div class="email-otp-boxsc">
                    ...
                    <form class="account-crt-frm" action="{{ url('umpire-signup') }}" method="POST">
                        @csrf
                        ...
                        <div class="foms-input">
                            ...
                            <label for="" class="inputlabel">Email<span>*</span> </label>
                            <input type="email" class="cutominput" id="emailInput" name="email">
                        ...
                        <div class="foms-input">
                            <label for="" class="inputlabel">Date Of Birth <span>*</span></label>
                            <input type="date" class="cutominput" name="dob">
                        </div>
                        <div class="foms-input">
                            <label for="" class="inputlabel">Zip <span>*</span></label>
                            <input type="number" class="cutominput" name="zipcode"
                                oninput="if(this.value.length > 5) this.value = this.value.substring(0, 5);">
                        </div>
                        <hr class="customs mt-50px mb-50px">
                        ...
                        <div class="alert alert-danger" style="display: none;margin-top: 20px;" id="errors"></div>
                        <div class="verifu pt-0 mart-top">
                            ...
                            <div class="emnails-tetx">
                                Already have an account? <a href="{{ url('umpire-login') }}" class="resend">Sign In</a>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function(e) {
            $('form').on('submit', (function(e) {
                ...
                $('#submitButton').text('Creating your account....');
                $.ajax({
