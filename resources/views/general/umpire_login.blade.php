                ...
                <div class="row flex-wrap-reverse">
                    <div class="col-md-6 px-0">
                        <div class="matginsyp">
                            ...
                            <form action="{{ url('umpire-login') }}" method="POST">
                                @csrf
                            ...
                            <div class="haveass mb-50px">
                                Don’t have an account? <a href="{{ url('umpire-signup') }}" class="resend">Sign Up</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6  px-0">
                        <img class="fulling" src="{{ asset('storage/frontend/image/ump-login.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
