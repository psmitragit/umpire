        ...
        <div class="sec-2-inner">
            ...
            <div class="container new-container">
                ...
                <div class="email-otp-boxsc">
                    <div class="heafres">
                        <h3 class="subtitle">League Admin</h3>
                    ...
                    <form class="account-crt-frm" action="{{ url('league-admin-signup') }}" method="POST">
                        @csrf
                        <div class="foms-input">
                            <label for="" class="inputlabel">League Name<span>*</span></label>
                            <input type="text" class="cutominput" name="" value="{{ $league->leaguename }}"
                                readonly>
                        </div>


                        <div class="foms-input">
                            <label for="" class="inputlabel">League Owner Name <span
                                    class="dif-color"></span><span></span></label>
                            <input type="text" class="cutominput" ame="" value="{{ $league->name }}" readonly>
                        </div>

                        <div class="foms-input">
                            <label for="" class="inputlabel">Phone No.</label>
                            <input type="tel" class="cutominput" ame="" value="{{ $league->phone }}" readonly>
                        </div>


                        <div class="foms-input">
                            <label for="" class="inputlabel">Email<span>*</span> </label>
                            <input value="{{ $email }}" disabled type="email" class="cutominput" id="emailInput"
                                name="">
                        ...
                        <div class="agreements-s">
                            ...
                            <label for="tandp">I Agree to <a target="_blank" href="{{ url('privacy-policy') }}">Privacy
                                    Policy</a> and <a target="_blank" href="{{ url('terms-of-use') }}">Terms of
                                    Uses</a></label>
                        ...
                        <div class="verifu pt-0 mart-top">
                            <div class="submitbtn"> <button type="submit" id="submitButton"
                                    class="buton-signup noshadow" disabled>Create my Account</button></div>
        ...
        function checkPasswordsMatchAndValidate() {
            ...
            if (
                ...
                passwordError.textContent =
                    "Password must have at least 8 characters, one uppercase letter (ABCD...), one number (123456789), and one special character (`~!@#$%^&*_-=\|]}).";
