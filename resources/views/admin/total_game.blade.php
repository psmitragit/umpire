                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <select id="course" class="selectd"
                                onchange="filter_preset(this.value, 'total-game')">
                        ...
                        <form class="forms-sample" method="post"
                            action="{{ url('admin/save_total_game/' . $preset->presetid) }}">
                            @csrf
        ...
        $(document).ready(function() {
            ...
            $('#add').click(function() {
                ...
                $('#dynamic_field').append('<tr id="row' + i +
                    ...
                    newFromValue +
                    '" type="number" name="from[]" placeholder="00" class="selectd name_list" required /><span>Games To</span></td><td><input type="number" name="to[]" placeholder="00" class="selectd name_list to-input" required /><span>Games</span></td> <td><select class="selectd"  required name="addless[]" id=""><option value="-">Deduct</option><option value="+">Add</option></select></td><td><input type="number" name="point[]" placeholder="00" class="selectd name_list" required /><span class="ms-2">Points</span></td><td><button type="button" name="remove" id="' +
