    ...
    <div class="body-content">
        ...
        <div class="namevs-anes">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <form class="forms-sample form" method="post" action="{{ url('league/save_pay') }}">
                        @csrf
                            ...
                            @if (!empty($page_data))
                                @foreach ($page_data as $key => $data)
                                    <section class="displayflesxsa tegss age" id="row{{ $key + 1 }}">
                                        ...
                                        <span class="text1s ">Between $</span>
                                        ...
                                        <div class="d-flex vsa">
                                            <span class="text2s mr-0 ">
                                                <select name="addless[]" class="noames-select custom-width-selector"
                                                    id="" required>
        ...
        $(document).ready(function() {
            ...
            $('#add').click(function() {
                ...
                var html = '<section class="displayflesxsa tegss age" id="row' + i +
                    '">';
                html += '<span class="text1s ">Between $</span>';
