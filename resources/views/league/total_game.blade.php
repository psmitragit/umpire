    ...
    <div class="body-content">
        ...
        <div class="namevs-anes">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <form class="forms-sample form" method="post" action="{{ url('league/save_total_game') }}">
                        @csrf
                        <div class="headrepages-point">
                            Total games umpire has done in this league
                        </div>
                                    ...
                                    <section class="displayflesxsa tegss age" id="row{{ $key + 1 }}">
                                        <div class="d-flex vsa">
                                            <span class="pists"><input type="number" class="name-inpostya name_list"
                                                    name="from[]" placeholder="00" required
                                                    value="{{ $data->from }}"></span>
                                            <span class="tos">Games To</span>

                                            <span class="pists"><input class="name-inpostya name_list to-input"
                                                    type="number" name="to[]" placeholder="00" required
                                                    value="{{ $data->to }}"></span>
                                            <span class="tos">Games </span>
                                        </div>
                                        <div class="d-flex vsa">
                                            ...
                                            <span class="pists"><input type="number" class="name-inpostya name_list"
                                                    name="point[]" placeholder="00" required
                                                    value="{{ $data->point }}"></span>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#add').click(function() {
                ...
                html += '</span>';
                html += '<span class="text1s ">Games To</span>';
                html += '<span class="pists">';
                html +=
                    '<input class="name-inpostya name_list to-input" type="number" name="to[]" placeholder="00" required>';
                html += '</span><span class="tos">Games</span><span class="text2s mr-0 ">';
                html +=
