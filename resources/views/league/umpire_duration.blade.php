    ...
    <div class="body-content">
        ...
        <div class="namevs-anes">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <form class="forms-sample form" method="post" action="{{ url('league/save_umpire_duration') }}">
                        @csrf
                        <div class="headrepages-point">
                            Duration that the umpire has been in league
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#add').click(function() {
                ...
                html += '</span>';
                html += '<span class="text1s ">Days To</span>';
                html += '<span class="pists">';
                html +=
                    '<input class="name-inpostya name_list to-input" type="number" name="to[]" placeholder="00" required>';
                html += '</span><span class="tos">Days</span><span class="text2s mr-0 ">';
                html +=
