...
class GameModel extends Model
{
    ...
    protected $fillable = ['leagueid', 'gamedate', 'gamedate_toDisplay', 'playersage', 'hometeamid', 'awayteamid', 'locid', 'umpreqd', 'ump1', 'ump2', 'ump3', 'ump4', 'report', 'report1', 'report2', 'report3', 'report4', 'ump1pay', 'ump1bonus', 'ump234pay', 'ump234bonus', 'paid_umpires'];
